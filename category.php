...
<body>
    ...
    <div class="h1 bg-danger text-white p-3 mb-4"> 
    ...
    <div class="container">
        <div class="row mb-4">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    echo "<div class='row'>";
                    echo     "<div class='col'>";
                    echo         "<div class='card shadow-lg p-2 bg-light text-dark'>Posted: " . date_format(new DateTime($row['date_time']), 'm/d/Y l g:ia') . "</div>";
                    echo     "</div>";
                    echo "</div>";
